...
object Mavericks {
    ...
    fun initialize(
        ...
        Mavericks.viewModelDelegateFactory = when {
            viewModelDelegateFactory != null -> viewModelDelegateFactory
            Mavericks.viewModelDelegateFactory !is DefaultViewModelDelegateFactory -> DefaultViewModelDelegateFactory()
            else -> Mavericks.viewModelDelegateFactory
        }
    }
}
